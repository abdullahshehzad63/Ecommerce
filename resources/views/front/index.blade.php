        ...
        <div class="row product__filter">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{asset($product->cover)}}">
                        <span class="label">New</span>
                        <ul class="product__hover">
                            <li><a href="#"><img src="{{asset('front-assests/img/icon/heart.png')}}" alt=""></a></li>
                            <li><a href="#"><img src="{{asset('front-assests/img/icon/compare.png')}}" alt=""> <span>Compare</span></a></li>
                            <li><a href="#"><img src="{{asset('front-assests/img/icon/search.png')}}" alt=""></a></li>
                        </ul>
                    </div>
                    <div class="product__item__text">
                        <h6>{{$product->title}}</h6>
                        <a href="{{route('shopDetails.home',$product->id)}}" class="add-cart">+ Add To Cart</a>
                        <div class="rating">
                        ...
                        {{-- <h5>{{$product->product_attributes->price}}</h5> --}}
                        @if($product->product_attributes->count())
                            <h5>{{$product->product_attributes->first()->price}}</h5>
                        @else
